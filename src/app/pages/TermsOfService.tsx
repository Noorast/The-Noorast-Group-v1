        ...
        <div className="max-w-3xl">
          ...
          <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="border-b border-border/50 pb-6">
              ...
              <p>Use of our free Services (the Website and the Property Passport) does not create a professional-client relationship between you and Noorast Group Limited or any individual associated with us. A professional engagement only arises where you and Noorast Group Limited enter into a separate written letter of appointment for specific architectural design services.</p>
            </div>
            <div className="border-b border-border/50 pb-6">
              <h3 className="text-foreground font-medium text-sm mb-2 tracking-wide">The Property Passport Toolkit</h3>
              <p>The Property Passport Toolkit is a paid digital workbook (£97 + VAT) offered by the studio as a resource for homeowners preparing to commission a project. It is a workbook only. It is not an architectural design service and does not constitute professional advice on your specific project. Any general guidance offered alongside it is general guidance only and does not constitute formal architectural, planning, structural, or legal advice on your project. As a digital product delivered immediately on purchase, it is non-refundable once access has been granted, save for your statutory rights.</p>
            </div>
            <div className="border-b border-border/50 pb-6">
      ...
      <section className="max-w-[1440px] mx-auto px-6 py-16 md:px-12 lg:px-16 border-b border-border">
        <div className="max-w-3xl">
          ...
          <div className="p-5 border border-border mb-6">
            <p className="text-sm text-muted-foreground leading-relaxed">For free use of our Website, the Property Passport, or any other free tool, our total aggregate liability to you shall not exceed £100.</p>
          </div>

          <h3 className="text-foreground font-medium text-sm mb-3 tracking-wide">Liability cap, paid services</h3>
          <div className="p-5 border border-border mb-6">
            <p className="text-sm text-muted-foreground leading-relaxed">For any paid service purchased through the Website, our total aggregate liability to you arising from or in connection with that purchase shall not exceed three (3) times the fees paid to us for that service in the 12 months preceding the claim.</p>
          </div>
