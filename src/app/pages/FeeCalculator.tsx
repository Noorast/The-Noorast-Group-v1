    ...
    <div>
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 pt-20 pb-0 md:pt-28">
        <div className="max-w-3xl reveal">
          <p className="eyebrow-tick" style={{ fontSize: '0.75rem', letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--bau-black)', fontWeight: 700, marginBottom: '1.75rem' }}>
            Fee guide
          </p>
          <h1 style={{ letterSpacing: '-0.025em', marginBottom: '1.75rem', fontWeight: 500 }}>An indication, before we speak.</h1>
          ...
          <div className="lg:col-span-5 lg:col-start-8 reveal" style={{ transitionDelay: '0.1s' }}>
            <div style={{ position: 'sticky', top: '7rem' }}>
              ...
              <p style={{ fontSize: 'clamp(2.25rem, 4.5vw, 3.5rem)', fontWeight: 200, letterSpacing: '-0.03em', lineHeight: 1.05, color: 'var(--foreground)', marginBottom: '0.5rem', fontVariantNumeric: 'tabular-nums' }}>
                {gbp(result.low)}<span style={{ color: 'rgba(40,30,20,0.35)', margin: '0 0.6rem', fontSize: '0.6em', fontWeight: 500 }}>to</span>{gbp(result.high)}
              </p>
              ...
              <div style={{ marginTop: '2.5rem', paddingTop: '1.75rem', borderTop: '2px solid var(--bau-black)' }}>
