...
const s = {
  eyebrow: { fontSize: '0.75rem', letterSpacing: '0.06em', textTransform: 'uppercase' as const, color: 'rgba(255,255,255,0.28)' },
  eyebrowLight: { fontSize: '0.75rem', letterSpacing: '0.06em', textTransform: 'uppercase' as const, color: 'var(--muted-foreground)', opacity: 0.42 },
...
export function International() {
  ...
  return (
    <div>
      ...
      {/* HERO — dark */}
      <section className="w-full overflow-hidden" style={{ height: '85vh', minHeight: 480, position: 'relative', background: 'var(--bau-black)' }}>
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-24 md:py-36">
        <div className="max-w-3xl reveal" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <p style={s.body}>
            The studio has worked on projects across Europe, the Middle East, and South Asia. The design is led from London. Delivery is handled by a trusted partner on the ground who knows the contractors, the local rules, and the way things actually get built. You have one point of contact in the UK and another on the ground.
          </p>
          <p style={s.body}>
      ...
      <section style={{ borderTop: '2px solid var(--bau-black)', background: 'var(--bau-black)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              ...
              <div key={step.n} className="reveal" style={{ transitionDelay: `${i * 0.1}s` }}>
                ...
                <h3 style={{ fontSize: '1.125rem', fontWeight: 500, color: '#f0ede8', marginBottom: '1rem', letterSpacing: '-0.01em' }}>{step.title}</h3>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-20 md:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-4 reveal">
              ...
              <p style={{ fontSize: 'clamp(1.25rem, 2vw, 1.625rem)', fontWeight: 500, letterSpacing: '-0.02em', lineHeight: 1.4, color: 'var(--foreground)' }}>
      ...
      <section className="joint">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-20 flex flex-wrap items-center justify-between gap-8 reveal">
          <div>
            <h3 style={{ fontSize: '1.25rem', fontWeight: 500, marginBottom: '0.75rem' }}>Tell us about your project.</h3>
