...
const roles = [
  ...
  {
    title: 'Delivery partners abroad',
  ...
  return (
    <div>
      <SEO
        ...
        description="Join Noorast. We work with architects, designers, and specialists on a core and project basis. Remote, with the studio in London."
        path="/careers"
      />
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 pt-20 pb-12 md:pt-28 md:pb-16">
        <div className="max-w-3xl reveal">
          ...
          <h1 style={{ letterSpacing: '-0.02em', marginBottom: '1.5rem' }}>Work with the studio.</h1>
          <p style={{ ...s.body, maxWidth: '40rem' }}>
            We're a small team that brings in specialists per project. We're always glad to hear from people who care about residential work done properly, whether that's a role or a collaboration.
          </p>
        </div>
      </section>
      ...
      <section className="joint">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-8 md:py-12">
          {roles.map((r, i) => (
            <div key={r.title} className="reveal" style={{ borderTop: i === 0 ? 'none' : '2px solid var(--bau-black)', padding: '2.5rem 0' }}>
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                <div className="lg:col-span-4">
                  <h2 style={{ fontSize: '1.375rem', fontWeight: 500, letterSpacing: '-0.02em', color: 'var(--foreground)', marginBottom: '0.5rem' }}>{r.title}</h2>
      ...
      <section className="joint">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-16 flex flex-wrap items-center justify-between gap-8 reveal">
          <div style={{ maxWidth: '34rem' }}>
            <h3 style={{ fontSize: '1.25rem', fontWeight: 500, letterSpacing: '-0.01em', marginBottom: '0.75rem' }}>Nothing that fits?</h3>
          ...
          <a href="mailto:design@noorast.co.uk?subject=Careers%20open%20application" style={s.link}>Send a portfolio →</a>
        </div>
      </section>
    </div>
  );
